...
<div id="footer">
	<div class="container">
		<div class="row">
			<div class="col-md-4">
			<h4 class="colorwhite">Kontakt:</h4>
				<p class="colorwhite">Kvindesmedien Aps 
Mælkevejen 83 E <br>
1440 København
<br>
<br>

<span class="bold">Telefon:</span> 3257 7658
<br>
<span class="bold">Email:</span> kontakt@kvindesmedien.dk
 </p>
			</div>
